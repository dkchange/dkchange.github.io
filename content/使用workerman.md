...
基於上述缺點，我們希望建一個 PHP 守護進程，如果要有一個 PHP 守護進程，我們必須要創一個無窮迴圈來處理這件事情
[PHP Daemon 教學](https://alexwebdevelop.com/php-daemons/)
到最後出現
[[PHPDaemon]]、[[ReactPHP]]、[[Ratchet]]、[[Workerman]]、[[Swoole]]
等技術來處理我們的問題

直上官網連結
[Workerman 官網](https://www.workerman.net/workerman)
